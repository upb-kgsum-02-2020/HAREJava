...
public class TransitionMatrixTest {
	...
	public static List<Statement> actualTriples = new ArrayList<Statement>(
			Arrays.asList(ResourceFactory.createStatement(r1, p1, r3), ResourceFactory.createStatement(r1, p2, r2)));

	public List<Resource> actualEntity = new ArrayList<Resource>(Arrays.asList(r1, p1, p2, r2, r3));
	...
	public void setupMatrixTest() {
		TransitionMatrixUtil matrixUtil = new TransitionMatrixUtil(data());
		...
		F_actual.setAsDouble(0.0, 2, 0);
		F_actual.setAsDouble(1, 2, 1);
		
		F_actual.setAsDouble(0, 3, 0);
		F_actual.setAsDouble(1, 3, 1);
		
		F_actual.setAsDouble(1, 4, 0);
		F_actual.setAsDouble(0, 4, 1);
		...
		W_actual.setAsDouble(0, 0, 2);
		W_actual.setAsDouble(0, 0, 3);
		W_actual.setAsDouble(a, 0, 4);
		
		
		W_actual.setAsDouble(a, 1, 0);
		W_actual.setAsDouble(0, 1, 1);
		W_actual.setAsDouble(a, 1, 2);
		W_actual.setAsDouble(a, 1, 3);
		W_actual.setAsDouble(0, 1, 4);
		
		System.out.println(matrixUtil.getTripleList());
		System.out.println(matrixUtil.getEntityList());
	...
	//	Matrix P_T_actual = W_actual.mtimes(F_actual);
		...
		//Assert.assertEquals(matrixUtil.getF(), F_actual);

	}

	public static void main(String[] args) {
		TransitionMatrixTest test = new TransitionMatrixTest();
		test.setupMatrixTest();
	}
	...
	public void getDimensionValuesTest() {
		...
		System.out.println(matrixUtil.getAlpha());
