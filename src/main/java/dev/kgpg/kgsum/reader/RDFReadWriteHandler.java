...
public class RDFReadWriteHandler {
	public void writeFilteredTriples(
		...
		String outputTtlPath = "./kgsum/kgsum/src/main/resources/kgsum-visualization/src/" + outputTtl;
		String outputJsonPath = "./kgsum/kgsum/src/main/resources/kgsum-visualization/src/" + outputJson;
//		String outputJson2 = datasetname.concat("_result2.json");

		FileOutputStream streamTtl, streamJson, streamJson2;
		try {
			streamTtl = new FileOutputStream(outputTtlPath);
			streamJson = new FileOutputStream(outputJsonPath);
